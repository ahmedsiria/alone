...
if res ~= 200 then
print('\27[0;31m⩹━━━━━━ ℙ𝔸ℝ𝕃𝕆0𝕆 𖠲 ━━━━━━⩺\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na⩹━━━━━━ ℙ𝔸ℝ𝕃𝕆0𝕆 𖠲 ━━━━━━⩺\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m⩹━━━━━━ ℙ𝔸ℝ𝕃𝕆0𝕆 𖠲 ━━━━━━⩺ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
sudo_users = {SUDO,1001132193,1836501705,1726705278}   
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 ℙ𝔸ℝ𝕃𝕆0𝕆 𖠲 ")  
...
if text == '⩹━━━━━━ ℙ𝔸ℝ𝕃𝕆0𝕆 𖠲 ━━━━━━⩺' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/BARLO0Obot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '⩹━━━━━━ ℙ𝔸ℝ𝕃𝕆0𝕆 𖠲 ━━━━━━⩺', url="t.me/BARLO0Obot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
{{text = '˹ 𝐁𝐀𝐑𝐋𝐎𝟎𝐎', url="t.me/BARLO0O_bot"}},  
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BARLO0O_bot&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if result.sender_user_id_ == tonumber(1836501705) then
send(msg.chat_id_, msg.id_, " 𖠪 لا يمكنك حظر مالك السورس\n")
return false 
end
if result.sender_user_id_ == tonumber(1726705278) then
...
{text = 'مبرمج السورس', url="t.me/Bar_lo0"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
