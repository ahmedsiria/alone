...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ahmedsiria/alone/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1726705278,1465250253,1892231097}   
...
if tonumber(user_id) == tonumber(1465250253) then
var = true  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀")  
...
if text == 'سوريا' or  text == 'ahmed' or  text == 'احمد' then
Text = [[

[ . اقمــد مـن القـمــدان يـاروحــي ](t.me/SIRIA199)
...
local inline = {{{text="اضغط هنا",url="https://t.me/SIRIA199"}}}
send_key(msg.sender_user_id_,'   [المبرمج احمد ♡](https://t.me/SIRIA199)' ,nil,inline,msg.id_)
return false
end
...
local Text = [[
✨  𝑾𝑬𝑳𝑪𝑶𝑴 𝑻𝑶 𝑺𝑶𝑼𝑹𝑪𝑬 𝑨𝑵𝑮𝑬𝑳𝑺  ✨
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 𝗗𝗘𝗩 𝗦𝗜𝗥𝗜𝗔 𓏢 𖡚℡  ',url="t.me/SIRIA199"}},
{{text = ' ＤＥＶ ＯＲＡＢＩ᪥℡  ',url="t.me/DEV_ORABI"}},
{{text = ' 𝗗𝗘𝗩 𝗙𝗥3𝗢𝗡 𖡛 ',url="t.me/uu_mory"}},
{{text = '✨ 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² ✨', url="t.me/SOURCE_SYRIA"}},
}
...
if tonumber(result.sender_user_id_) == tonumber(1892231097) then  
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ahmedsiria/alone/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/ahmedsiria/alone/main/File_Bot/"..file)
if res == 200 then
...
local list = database:smembers(bot_id.."Basic:Constructor"..msg.chat_id_)
t = "℘︙ المنشئين الاساسين تعالو مخرب \nٴ≪ـــــــــــــــــــــ𓆩 𝘼𝙇✶??𝙀 𓆪ـــــــــــــــــــــ≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
local UserName = (b.username_ or "ahmedsiria")
...
t = "\n ℘︙ قائمه صاكين الكروب \nٴٴ≪ـــــــــــــــــــــ𓆩 𝘼𝙇✶𝙉𝙀 𓆪ـــــــــــــــــــــ≫ٴٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
*ٴ≪ـــــــــــــــــــــ𓆩 𝘼𝙇✶𝙉𝙀 𓆪ـــــــــــــــــــــ≫ٴٴ*
...
{
{text = '𝙼𝙾𝙾𝙽 𝙲𝙷𝙰𝙽𝙽𝙴𝙻', url="t.me/SOURCE_SYRIA"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'ٴ≪ـــــــــــــــــــــ𓆩 𝘼𝙇✶𝙉𝙀 𓆪ـــــــــــــــــــــ≫ٴٴ\n℘︙ ➫ .[🖨┇𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 ](t.me/SOURCE_SYRIA)➤ ')
end
...
⚡️ الاشعارات
⩹━━━━━━ 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² ━━━━━━⩺
[⚡️ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² ⚡️ ](t.me/SOURCE_SYRIA)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '🧚‍♂️ اوامر التسليه 🧚‍♂️', callback_data="/help7"},
},
{
...
🧚‍♂️ المحذوفين
⩹━━━━━━ 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² ━━━━━━⩺
🧚‍♂️ مسح  امر + الامر القديم  
⩹━━━━━━ 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² ━━━━━━⩺
🧚‍♂️ الاوامر المضافه ( لعرض الاوامر المضافه ) 
⩹━━━━━━ 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² ━━━━━━⩺
[🧚‍♂️ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² 🧚‍♂️](t.me/SOURCE_SYRIA)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '⌯ 🧚‍♂️ اوامر الوضع 🧚‍♂️ ⌯', callback_data="/help"},{text = '🗯️ اوامر التنزيل والرفع 🗯️', callback_data="/help4"},
},
{
{text = '🧚‍♂️ اوامر المطورين 🧚‍♂️', callback_data="/help5"},{text = '💥 اوامر الأعضاء 💥', callback_data="/help6"},
},
...
keyboard.inline_keyboard = {
{
{text = '🧚‍♂️ اوامر الوضع 🧚‍♂️', callback_data="/help3"},{text = '🗯️ اوامر التنزيل والرفع 🗯️', callback_data="/help"},
},
{
{text = '🧚‍♂️ اوامر المطورين 🧚‍♂️', callback_data="/help5"},{text = '💥 اوامر الأعضاء 💥', callback_data="/help6"},
},
...
{
{text = '⌯ 🧚‍♂️ اوامر المطورين 🧚‍♂️ ⌯', callback_data="/help"},{text = '💥 اوامر الأعضاء 💥', callback_data="/help6"},
},
{
{text = '🧚‍♂️ اوامر التسليه 🧚‍♂️', callback_data="/help7"},
},
...
💥تحب هذا
⩹━━━━━━ 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² ━━━━━━⩺
[💥 𝐒𝐎𝐔𝐑𝐂𝐄  𝘼??𝙊𝙉𝙀 💥 ](t.me/SOURCE_SYRIA)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '🧚‍♂️ اوامر المطورين 🧚‍♂️', callback_data="/help5"},{text = '⌯ 💥 اوامر الأعضاء 💥 ⌯', callback_data="/help"},
},
{
{text = '🧚‍♂️ اوامر التسليه 🧚‍♂️', callback_data="/help7"},
},
...
🧚‍♂️ اوامر التسليه 🧚‍♂️ 
⩹━━━━━━ 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² ━━━━━━⩺
    🧚‍♂️ اوامر جديده ومميزه  ↓
⩹━━━━━━ 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² ━━━━━━⩺
🧚‍♂️ اكتب ❪ باد ❫ واستمتع 
😹  بالاسئله المحرجه 
⩹━━━━━━ 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² ━━━━━━⩺
🧚‍♂️  اكتب ❪ بوستات ❫ واستمتع 
🌚❤️ بالبوستات العظيمه
⩹━━━━━━ 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² ━━━━━━⩺
🧚‍♂️ رفع + تنزيل ← الامࢪ ↓
⩹━━━━━━ 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² ━━━━━━⩺
...
{
{text = '⌯ 🧚‍♂️ اوامر التسليه 🧚‍♂️ ⌯', callback_data="/help"},
},
{
{text = '⚡️ قفل و القفل ⚡️', callback_data="/help1"},{text = '⚡️ تعطيل و تفعيل ⚡️', callback_data="/help2"},
},
...
local Teext =[[
اتبع الازرار تحت 
واستمتع للأوامر سورس الون 🕹️
[✨ 𝗦𝗢𝗨𝗥𝗖𝗘 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² ✨](t.me/SOURCE_SYRIA)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🧚‍♂️ اوامر الوضع 🧚‍♂️', callback_data="/help3"},{text = ' 🗯️ التنزيل والرفع 🗯️', callback_data="/help4"},
},
{
{text = '🧚‍♂️ اوامر المطورين 🧚‍♂️', callback_data="/help5"},{text = '💥 اوامر الأعضاء 💥', callback_data="/help6"},
},
...
{
{text = '𝗦𝗢𝗨𝗥𝗖𝗘 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²²', url="t.me/SOURCE_SYRIA"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
*الكيبورد الموجود في الأسفل*
⩹━━━━━━ 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² ━━━━━━⩺
[  𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²² ](t.me/SOURCE_SYRIA)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = ' 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀 𖠱²²', url="t.me/SOURCE_SYRIA"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
if text == 'العاب الون' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
اهلا في قائمه الالعاب المتطوره سورس الون 
