...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ 𝐌𝐎o ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ 𝐌𝐎o ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ 𝐌𝐎o ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ahmedsiria/Files_Dragon/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,859213488,1208165035,1188292832,859213488}   
...
var = true  
elseif tonumber(user_id) == tonumber(1188292832) then
var = true  
...
local UserName = (data.username_ or "SO_MOONN")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙼𝙾𝙾𝙽")  
...
--------------------------------------------------------------------------------------------------------------
local checka =string.find(text, "حصل خير")
if checka then
Text = [[

[ . هيجي منين الخير بوشك ده 🙂😂 ]

]]
send(msg.chat_id_, msg.id_,Text)
return false
end
local checka =string.find(text, "احا")
if checka then
Text = [[
...
[ . مطور السورس ](t.me/Yussef2000)

]]
send(msg.chat_id_, msg.id_,Text)
return false
end
if text == 'حمو' or text == 'مو ابراهيم'  or text == 'محمد ابراهيم' then
Text = [[

مطور سورس وبوت 𝖒𝖔𝖔𝖓 مشغول الآن يرُجى ترك رسالة نصية له في الخاص ..☏ @mo1ibrahim
...
os.execute('wget https://raw.githubusercontent.com/ahmedsiria/alone/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ℘︙ تم تحديث السورس \n ℘︙ لديك اخر اصدار لسورس موون\n ℘︙ الاصدار » { v 1.5}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ℘' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ℘︙ اصدار سورس موون \n ℘︙ الاصدار »{ v 1.5}')
end
...
if MsgText[1]== "مبرمج السورس" and msg.type == "pv" then
local inline = {{{text="اضغط هنا",url="https://t.me/AAHMEED11"}}}
send_key(msg.sender_user_id_,'   [المبرمج احمد ♡](https://t.me/AAHMEED11)' ,nil,inline,msg.id_)
return false
end
if MsgText[1]== "مالك السورس" and msg.type == "pv" then
local inline = {{{text="اضغط هنا",url="https://t.me/AAHMEED11"}}}
send_key(msg.sender_user_id_,'   [المالك محمد ♡](https://t.me/mo1ibrahim)' ,nil,inline,msg.id_)
return false
end
...
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'SO_MOONN')..')'
status  = '\n ℘︙ تم ترقيته مطور'
...
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_MOONN')..')'
status  = '\n ℘︙ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ℘︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SO_MOONN')..') \n ℘︙ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ℘︙ العضو : {["..data.first_name_.."](T.ME/SO_MOONN)}\n ℘︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ℘︙ عذرا » {["..data.first_name_.."](T.ME/SO_MOONN)}\n ℘︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙼𝙾𝙾𝙽 ♡
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مالك السورس 🧸️',url="t.me/mo1ibrahim"}},
{{text = 'مطور السورس 🧸️',url="t.me/Yussef2000"}},
{{text = 'قناة السورس 📝', url="t.me/SO_MOONN"}},
{{text = 'اضف البوت الي مجموعتك🥺🧡', url="https://telegram.me/moon6_bot?startgroup=start"}},
}
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ℘︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SO_MOONN')..') \n ℘︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ℘︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SO_MOONN')..') \n ℘︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1188292832) then  
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ahmedawad10/Files_Dragon/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ℘︙ اهلا بك في متجر ملفات موون\n ℘︙ ملفات السورس ↓\nٴ≪┉ ┉ ┉ ┉ ┉ 𝐌𝐎o ┉  ┉ ┉ ┉ ┉≫ٴ\n\n"
local TextE = "\nٴ≪┉ ┉ ┉ ┉ ┉ 𝐌𝐎o ┉  ┉ ┉ ┉ ┉≫ٴ\n ℘︙ علامة تعني { ✔️ } ملف مفعل\n ℘︙ علامة تعني { ✖ } ملف معطل\n ℘︙ قناة سورس موون ↓\n".." ℘︙ [اضغط هنا لدخول](t.me/SO_MOONN) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ℘︙ عذرا الملف لايدعم سورس موون \n") 
end
return false
end
...
local UserName = (b.username_ or "ahmedawad10")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_MOONN')..')'
status  = '\n ℘︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ℘︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_MOONN')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ℘︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'SO_MOONN')..')'..'\n ℘︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'موون').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'موون')
local DRAGON_Msg = {
'عمغي 🥺💕.',
...
database:set(bot_id.."SO_MOONN:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."SO_MOONN:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."SO_MOONN:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."SO_MOONN:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"℘︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."SO_MOONN:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."SO_MOONN:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس موون يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'موون').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_MOONN')..')'
local iduser = result.sender_user_id_
...
{
{text = '𝙼𝙾𝙾𝙽 𝙲𝙷𝙰𝙽𝙽𝙴𝙻', url="t.me/SO_MOONN"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ 𝐌𝐎o ┉  ┉ ┉ ┉ ┉≫ٴٴ\n℘︙ ➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙼𝙾𝙾𝙽 ](t.me/SO_MOONN)➤ ')
end
...
{
{text = '𝙼𝙾??𝙽 𝙲𝙷𝙰𝙽𝙽𝙴𝙻', url="t.me/SO_MOONN"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'موون')
