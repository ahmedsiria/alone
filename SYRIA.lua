...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ahmedsiria/Files_Boyka/master/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevSYRIAW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevSYRIAW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevSYRIAW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevSYRIAW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevSYRIAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevSYRIAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevSYRIAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if not DevSYRIAW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevSYRIAW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text == 'تفعيل التواصل ♡' and DevSYRIAW(msg) then  
...
if text == 'تعطيل التواصل ♡' and DevSYRIAW(msg) then  
...
if text == 'تفعيل البوت الخدمي ♡' and DevSYRIAW(msg) then  
...
if text == 'تعطيل البوت الخدمي ♡' and DevSYRIAW(msg) then  
...
if text == 'ضع كليشه ستارت ♡' and DevSYRIAW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ♡ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ♡' and DevSYRIAW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ♡ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ♡' and DevSYRIAW(msg) then 
...
if text == 'تحديث السورس ♡' and DevSYRIAW(msg) then 
os.execute('rm -rf SYRIA.lua')
os.execute('wget https://raw.githubusercontent.com/ahmedsiria/SYRIA/master/SYRIA.lua')
send(msg.chat_id_, msg.id_,' ♡ تم تحديث السورس \n ♡ لديك اخر اصدار لسورس تيربو\n ♡ الاصدار » { 1.3v}')
dofile('SYRIA.lua')  
end
if text == 'الاصدار ♡' and DevSYRIAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ♡ اصدار سورس تيربو \n ♡ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ♡' and DevSYRIAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ♡ [تحديثات البوت](t.me/SOURCE_SYRIA) \n ♡ [قناه السورس](t.me/SOURCE_SYRIA)')
end
if text == "ضع اسم للبوت ♡" and DevSYRIAW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ♡ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ♡' and DevSYRIAW(msg) then 
...
if text == 'المشتركين ♡' and DevSYRIAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ♡ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'المجموعات ♡' and DevSYRIAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ♡ المجموعات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ♡") and DevSYRIAW(msg) then
...
if text == ("قائمه العام ♡") and DevSYRIAW(msg) then
...
if text == ("قائمه الكتم العام ♡") and DevSYRIAW(msg) then
...
if text=="اذاعه خاص ♡" and msg.reply_to_message_id_ == 0 and DevSYRIAW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ♡ ارسل الان اذاعتك؟ \n ♡ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ♡" and msg.reply_to_message_id_ == 0 and DevSYRIAW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ♡ ارسل الان اذاعتك؟ \n ♡ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ♡" and msg.reply_to_message_id_ == 0 and DevSYRIAW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ♡ ارسل الان اذاعتك؟ \n ♡ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ♡" and msg.reply_to_message_id_ == 0  and DevSYRIAW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ♡ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ♡" and msg.reply_to_message_id_ == 0  and DevSYRIAW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ♡ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ♡' and DevSYRIAW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ♡" and DevSYRIAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف المجموعات ♡" and DevSYRIAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'♡  عدد المجموعات الان » { '..#group..' }'..SYRIAk..''..SYRIA..'\n♡  الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevSYRIAW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevSYRIAW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevSYRIAW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevSYRIAW(msg) then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSYRIAW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevSYRIAW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevSYRIAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ♡ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevSYRIAW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ♡ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ♡" and DevSYRIAW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ♡ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ♡$") and DevSYRIAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ♡ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ♡" and DevSYRIAW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ♡" and DevSYRIAW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ♡ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ♡" and DevSYRIAW(msg) then  
...
database:sadd(bot_id.."SYRIA:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."SYRIA:blocname"..msg.chat_id_)
...
if name_Boyka then 
names_Boyka = database:smembers(bot_id.."SYRIA:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."SYRIA:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."SYRIA:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."SYRIA:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."SYRIA:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."SYRIA:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_Boykaa_new(Boyka1,Boyka2)
if Boyka2 and Boyka2.first_name_ then 
if Boyka2.first_name_:match("(.*)"..database:get(bot_id.."SYRIA:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."SYRIA:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Boyka_nnn = database:get(bot_id.."SYRIA:nump"..msg.chat_id_) or 5
local Boyka_nnn2 = database:get(bot_id.."SYRIA:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Boyka_nnn2) == tonumber(Boyka_nnn) or tonumber(Boyka_nnn2) > tonumber(Boyka_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."SYRIA:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "♡ عزيزي >>["..Boyka2.username_.."](https://t.me/"..(Boyka2.username_ or "SOURCE_SYRIA")..")\n♡ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."SYRIA:teh"..msg.chat_id_).."} بجانب اسمك\n♡ عدد المحاولات المتبقيه {"..(tonumber(Boyka_nnn) - tonumber(Boyka_nnn2)).."}")
end
end
end
end
...
local SYRIAChengName = database:get(bot_id.."SYRIA:Cheng:Name"..data.id_)
if not data.first_name_ then 
if SYRIAChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..SYRIAChengName..']')
database:del(bot_id.."SYRIA:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if SYRIAChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."SYRIA:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local SYRIAChengUserName = database:get(bot_id.."SYRIA:Cheng:UserName"..data.id_)
if not data.username_ then 
if SYRIAChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..SYRIAChengUserName..']')
database:del(bot_id.."SYRIA:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if SYRIAChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."SYRIA:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local SYRIAChengPhoto = database:get(bot_id.."SYRIA:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if SYRIAChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."SYRIA:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if SYRIAChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."SYRIA:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevSYRIAW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevSYRIAW(msg) then    
dofile('SYRIA.lua')  
send(msg.chat_id_, msg.id_, ' ♡ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevSYRIAW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevSYRIAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevSYRIAW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevSYRIAW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevSYRIAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevSYRIAW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevSYRIAW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevSYRIAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevSYRIAW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevSYRIAW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevSYRIAW(msg) then
...
if text == 'الملفات' and DevSYRIAW(msg) then
t = ' ♡ ملفات السورس تيربو ↓\n≪━━━━━━SYRIA━━━━━━≫ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevSYRIAW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ahmedsiria/Files_Boyka/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ♡ اهلا بك في متجر ملفات تيربو\n ♡ ملفات السورس ↓\n≪━━━━━━SYRIA━━━━━━≫\n\n"
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevSYRIAW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/ahmedsiria/Files_Boyka/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('SYRIA.lua')  
else
send(msg.chat_id_, msg.id_," ♡ عذرا الملف لايدعم سورس تيربو \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevSYRIAW(msg) then
...
if text == "مسح الملفات" and DevSYRIAW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ♡ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevSYRIAW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevSYRIAW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local  statuss  = '\n ♡ تم رفع العضــو الخول في المجموعه \n ♡ تعال يخول ممكن نتعرف'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
status  = '\n ♡ تم تنزيل العضــو الخول من المجموعه\n ♡ امشي يكسمك انت خول برضو'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ♡ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n ♡ تم رفع العضــو عرص في المجموعه \n ♡ بطل تعريص بق يكسمك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ♡ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_SYRIA')..')'
status  = '\n ♡ تم تنزيل العضــو عرص من المجموعه\n ♡ يلا بيي يعرص'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ♡ تم تنزيل جميع الشراميط من المجموعه')
end
if text == ("تاك للشراميط") and Mod(msg) then
local list = database:smembers(bot_id..'Sakl:User'..msg.chat_id_)
t = "\n ♡ قائمة شراميط المجموعه \n≪━━━━━━SYRIA━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ♡ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_SYRIA')..')'
local  statuss  = '\n ♡ تم رفع العضو شرموط بالمجموعه\n ♡ الان اصبح شرموط المجموعه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' ♡ تم تنزيل جميع وتكات المجموعه')
end
if text == ("تاك للوتكات") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n ♡ قائمة وتكات المجموعه \n≪━━━━━━SYRIA━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
-----------------------------------------------------
if text == 'تنزيل المنايك' and Mod(msg) then
database:del(bot_id..'Motee:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ♡ تم تنزيل جميع المنايك بالمجموعه')
end
if text == ("تاك للمنايك") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n ♡ قائمة منايك المجموعه \n≪━━━━━━SYRIA━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
-----------------------------------------------------
if text == 'تنزيل الزواني' and Mod(msg) then
database:del(bot_id..'Hors:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ♡ تم تنزيل جميع الزواني بالمجموعه')
end
if text == ("تاك للزواني") and Mod(msg) then
local list = database:smembers(bot_id..'Hors:User'..msg.chat_id_)
t = "\n ♡ قائمة للزواني المجموعه \n≪━━━━━━SYRIA━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» الزاني [@"..username.."]\n"
else
t = t..""..k.."» الزاني `"..v.."`\n"
end
end
...
---------
if text == ("رفع زاني") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ♡ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_SYRIA')..')'
local  statuss  = '\n ♡ تم رفع زاني في المجموعه\n ♡ امشي يلا يكسمك من هنا'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل زاني")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-----------------------------------------------------
if text == 'تنزيل الاكساس' and Mod(msg) then
database:del(bot_id..'Tele:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ♡ تم تنزيل جميع اكساس بالمجموعه')
end
if text == ("تاك للاكساس") and Mod(msg) then
local list = database:smembers(bot_id..'Tele:User'..msg.chat_id_)
t = "\n ♡ قائمة اكساس المجموعه \n≪━━━━━━SYRIA━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» الكس [@"..username.."]\n"
...
-----------------------------------------------------
if text == 'تنزيل القامدين' and Mod(msg) then
database:del(bot_id..'Jred:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ♡ تم تنزيل جميع القامدين')
end
if text == ("تاك للقامدين") and Mod(msg) then
local list = database:smembers(bot_id..'Jred:User'..msg.chat_id_)
t = "\n ♡ قائمة القامدين المجموعه \n≪━━━━━━SYRIA━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» القامد [@"..username.."]\n"
else
t = t..""..k.."» القامد "..v.."\n"
end
end
if #list == 0 then
t = " ♡ لا يوجد قامد بمت روم متناك"
end
send(msg.chat_id_, msg.id_, t)
end
---------
if text == ("رفع قامد") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل قامد")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ♡ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_SYRIA')..')'
status  = '\n ♡ تم تنزيل القامد من المجموعه\n ♡ نت بقيت عضو يلا امشي'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if text == 'مسح كليشه المطور' and DevSYRIAW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ♡ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevSYRIAW(msg) then
...
if text == 'تفعيل الاذاعه' and DevSYRIAW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevSYRIAW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'تيربو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'تيربو')
local SYRIA_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
if database:get(bot_id..'Bc:Bots') and not DevSYRIAW(msg) then 
...
if text == ("مسح ردود المطور") and DevSYRIAW(msg) then 
...
if text == ("ردود المطور") and DevSYRIAW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ♡ قائمة ردود المطور \n≪━━━━━━SYRIA━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevSYRIAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevSYRIAW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'تيربو').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevSYRIAW(msg) then   
...
if text == 'تعطيل المغادره' and DevSYRIAW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n♡ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SYRIA')..') '
...
if text == 'استعاده الاوامر' and DevSYRIAW(msg) then
...
*♡م10 ◂ اوامر الاعضاء*
ٴ≪━━━━━━SYRIA━━━━━━≫ٴ
彡 .[SYRIA CHANNEL](t.me/SOURCE_SYRIA)➢ 
]]
...
send(msg.chat_id_, msg.id_, t..'ٴ♡ٴ≪━━━━━━SYRIA━━━━━━≫ٴ♡○ٴ\n♡ 彡 .[SYRIA CHANNEL](t.me/SOURCE_SYRIA)➢ ')
end
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"مووووووووواححح????","مابوس ولي😌😹","خدك/ج نضيف 😂","البوسه بالف حمبي 🌝💋","خلي يزحفلي وابوسه 🙊😻","كل شويه ابوسه كافي 😏","ماابوسه والله هذا زاحف🦎","محح هاي لخول صاكه??"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'تيربو')
